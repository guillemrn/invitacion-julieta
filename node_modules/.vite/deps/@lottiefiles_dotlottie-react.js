...
var G3 = (d, t, n) => t in d ? N3(d, t, { enumerable: true, configurable: true, writable: true, value: n }) : d[t] = n;
var p = (d, t, n) => G3(d, typeof t != "symbol" ? t + "" : t, n);
var V3 = class {
...
var Y3 = (() => {
  ...
  return function(t = {}) {
    var n;
    function h(e, i, a) {
      return (i = _(i)) in e ? Object.defineProperty(e, i, { value: a, enumerable: true, configurable: true, writable: true }) : e[i] = a, e;
    }
    function _(e) {
      var i = g(e, "string");
    ...
    var l = t, W, V, J = new Promise((e, i) => {
      W = e, V = i;
    }), m1 = Object.assign({}, l), c1 = "./this.program", D = "", u1;
    typeof document < "u" && document.currentScript && (D = document.currentScript.src), d && (D = d), D.startsWith("blob:") ? D = "" : D = D.substr(0, D.replace(/[?#].*/, "").lastIndexOf("/") + 1), u1 = async (e) => {
      if (e = await fetch(e, { credentials: "same-origin" }), e.ok) return e.arrayBuffer();
      throw Error(e.status + " : " + e.url);
    };
    var q = l.printErr || console.error.bind(console);
    Object.assign(l, m1), m1 = null, l.thisProgram && (c1 = l.thisProgram);
    var i1 = l.wasmBinary, K, _1 = false, f1, B, O, n1, Z, w, M, g1, L1;
    function s1() {
      var e = K.buffer;
      l.HEAP8 = B = new Int8Array(e), l.HEAP16 = n1 = new Int16Array(e), l.HEAPU8 = O = new Uint8Array(e), l.HEAPU16 = Z = new Uint16Array(e), l.HEAP32 = w = new Int32Array(e), l.HEAPU32 = M = new Uint32Array(e), l.HEAPF32 = g1 = new Float32Array(e), l.HEAPF64 = L1 = new Float64Array(e);
    }
    var k1 = [], x = [], y1 = [];
    function n3() {
    ...
    function D1(e) {
      var i;
      throw (i = l.onAbort) === null || i === void 0 || i.call(l, e), e = "Aborted(" + e + ")", q(e), _1 = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), V(e), e;
    }
    var L2 = (e) => e.startsWith("data:application/octet-stream;base64,"), T1;
    async function a3(e) {
      if (!i1) try {
        var i = await u1(e);
      ...
      if (e == T1 && i1) e = new Uint8Array(i1);
      else throw "both async and sync fetching of the wasm failed";
      return e;
    }
    async function r3(e, i) {
      try {
        var a = await a3(e);
        return await WebAssembly.instantiate(a, i);
      } catch (r) {
    ...
    async function s3(e) {
      var i = T1;
      if (!i1 && typeof WebAssembly.instantiateStreaming == "function" && !L2(i) && typeof fetch == "function") try {
        var a = fetch(i, { credentials: "same-origin" });
    ...
    class y2 {
      constructor(i) {
        h(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${i})`, this.status = i;
      }
    }
    var Q1 = (e) => {
      for (; 0 < e.length; ) e.shift()(l);
    }, X1 = l.noExitRuntime || true, w2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, F1 = function() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN;
      var a = O, r = e + i;
      for (i = e; a[i] && !(i >= r); ) ++i;
      if (16 < i - e && a.buffer && w2) return w2.decode(a.subarray(e, i));
      for (r = ""; e < i; ) {
        var s = a[e++];
        if (s & 128) {
          var o = a[e++] & 63;
          if ((s & 224) == 192) r += String.fromCharCode((s & 31) << 6 | o);
            ...
            var u = a[e++] & 63;
            s = (s & 240) == 224 ? (s & 15) << 12 | o << 6 | u : (s & 7) << 18 | o << 12 | u << 6 | a[e++] & 63, 65536 > s ? r += String.fromCharCode(s) : (s -= 65536, r += String.fromCharCode(55296 | s >> 10, 56320 | s & 1023));
          }
    ...
    var v1 = {}, h1 = {}, W1 = {}, b1, a1 = (e, i, a) => {
      function r(c) {
        if (c = a(c), c.length !== e.length) throw new b1("Mismatched type converter count");
        for (var f = 0; f < e.length; ++f) H(e[f], c[f]);
      }
      e.forEach((c) => W1[c] = i);
      var s = Array(i.length), o = [], u = 0;
      i.forEach((c, f) => {
        h1.hasOwnProperty(c) ? s[f] = h1[c] : (o.push(c), v1.hasOwnProperty(c) || (v1[c] = []), v1[c].push(() => {
          s[f] = h1[c], ++u, u === o.length && r(s);
        }));
      }), o.length === 0 && r(s);
    }, M2, A = (e) => {
      for (var i = ""; O[e]; ) i += M2[O[e++]];
      return i;
    }, y;
    function h3(e, i) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var r = i.name;
      if (!e) throw new y(`type "${r}" must have a positive integer typeid pointer`);
      if (h1.hasOwnProperty(e)) {
        if (a.hb) return;
        throw new y(`Cannot register type '${r}' twice`);
      }
      h1[e] = i, delete W1[e], v1.hasOwnProperty(e) && (i = v1[e], delete v1[e], i.forEach((s) => s()));
    }
    function H(e, i) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      return h3(e, i, a);
    ...
    }, S2 = (e, i, a) => i === a ? e : a.Ga === void 0 ? null : (e = S2(e, i, a.Ga), e === null ? null : a.$a(e)), I2 = {}, d3 = {}, l3 = (e, i) => {
      if (i === void 0) throw new y("ptr should not be undefined");
      for (; e.Ga; ) i = e.Qa(i), e = e.Ga;
      return d3[i];
    }, x1 = (e, i) => {
      if (!i.Da || !i.Ca) throw new b1("makeClassHandle requires ptr and ptrType");
      if (!!i.Ha != !!i.Fa) throw new b1("Both smartPtrType and smartPtr must be specified");
      return i.count = { value: 1 }, S1(Object.create(e, { Aa: { value: i, writable: true } }));
    }, S1 = (e) => typeof FinalizationRegistry > "u" ? (S1 = (i) => i, e) : (t2 = new FinalizationRegistry((i) => {
      i = i.Aa, --i.count.value, i.count.value === 0 && (i.Fa ? i.Ha.Ka(i.Fa) : i.Da.Ba.Ka(i.Ca));
    }), S1 = (i) => {
      var a = i.Aa;
      return a.Fa && t2.register(i, { Aa: a }, i), i;
    }, b2 = (i) => {
      t2.unregister(i);
    }, S1(e));
    function $1() {
    }
    var I1 = (e, i) => Object.defineProperty(i, "name", { value: e }), P2 = (e, i, a) => {
      if (e[i].Ea === void 0) {
        var r = e[i];
        e[i] = function() {
          for (var s = arguments.length, o = new Array(s), u = 0; u < s; u++) o[u] = arguments[u];
          if (!e[i].Ea.hasOwnProperty(o.length)) throw new y(`Function '${a}' called with an invalid number of arguments (${o.length}) - expects one of (${e[i].Ea})!`);
          return e[i].Ea[o.length].apply(this, o);
        }, e[i].Ea = [], e[i].Ea[r.Na] = r;
      }
    }, e2 = (e, i, a) => {
      if (l.hasOwnProperty(e)) {
        if (a === void 0 || l[e].Ea !== void 0 && l[e].Ea[a] !== void 0) throw new y(`Cannot register public name '${e}' twice`);
        if (P2(l, e, e), l[e].Ea.hasOwnProperty(a)) throw new y(`Cannot register multiple overloads of a function with the same number of arguments (${a})!`);
        l[e].Ea[a] = i;
      } else l[e] = i, l[e].Na = a;
    }, c3 = (e) => {
      e = e.replace(/[^a-zA-Z0-9_]/g, "$");
      var i = e.charCodeAt(0);
      return 48 <= i && 57 >= i ? `_${e}` : e;
    };
    function u3(e, i, a, r, s, o, u, c) {
      this.name = e, this.constructor = i, this.Ma = a, this.Ka = r, this.Ga = s, this.bb = o, this.Qa = u, this.$a = c, this.jb = [];
    }
    var i2 = (e, i, a) => {
      for (; i !== a; ) {
        if (!i.Qa) throw new y(`Expected null or instance of ${a.name}, got an instance of ${i.name}`);
        e = i.Qa(e), i = i.Ga;
      }
      return e;
    };
    function _3(e, i) {
      ...
      if (!i.Aa) throw new y(`Cannot pass "${o2(i)}" as a ${this.name}`);
      if (!i.Aa.Ca) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return i2(i.Aa.Ca, i.Aa.Da.Ba, this.Ba);
    }
    function f3(e, i) {
      if (i === null) {
        if (this.Ta) throw new y(`null is not a valid ${this.name}`);
      ...
      if (!i || !i.Aa) throw new y(`Cannot pass "${o2(i)}" as a ${this.name}`);
      if (!i.Aa.Ca) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && i.Aa.Da.Ra) throw new y(`Cannot convert argument of type ${i.Aa.Ha ? i.Aa.Ha.name : i.Aa.Da.name} to parameter type ${this.name}`);
      if (a = i2(i.Aa.Ca, i.Aa.Da.Ba, this.Ba), this.Sa) {
        if (i.Aa.Fa === void 0) throw new y("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (i.Aa.Ha === this) a = i.Aa.Fa;
            else throw new y(`Cannot convert argument of type ${i.Aa.Ha ? i.Aa.Ha.name : i.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            a = i.Aa.Fa;
            break;
          case 2:
            if (i.Aa.Ha === this) a = i.Aa.Fa;
              ...
              var r = i.clone();
              a = this.kb(a, z1(() => r.delete())), e !== null && e.push(this.Ka, a);
            }
            break;
          default:
    ...
    function v3(e, i) {
      ...
      if (!i.Aa) throw new y(`Cannot pass "${o2(i)}" as a ${this.name}`);
      if (!i.Aa.Ca) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (i.Aa.Da.Ra) throw new y(`Cannot convert argument of type ${i.Aa.Da.name} to parameter type ${this.name}`);
      return i2(i.Aa.Ca, i.Aa.Da.Ba, this.Ba);
    }
    function P1(e, i, a, r, s, o, u, c, f, m, v) {
      this.name = e, this.Ba = i, this.Ta = a, this.Ra = r, this.Sa = s, this.ib = o, this.ob = u, this.Ya = c, this.Ua = f, this.kb = m, this.Ka = v, s || i.Ga !== void 0 ? this.toWireType = f3 : (this.toWireType = r ? _3 : v3, this.Ja = null);
    }
    var O2 = (e, i, a) => {
      if (!l.hasOwnProperty(e)) throw new b1("Replacing nonexistent public symbol");
      l[e].Ea !== void 0 && a !== void 0 ? l[e].Ea[a] = i : (l[e] = i, l[e].Na = a);
    }, $, p3 = function(e, i) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return e.includes("j") ? (e = e.replace(/p/g, "i"), i = (0, l["dynCall_" + e])(i, ...a)) : i = $.get(i)(...a), i;
    }, m3 = (e, i) => function() {
      for (var a = arguments.length, r = new Array(a), s = 0; s < a; s++) r[s] = arguments[s];
      return p3(e, i, r);
    }, T = (e, i) => {
      e = A(e);
      var a = e.includes("j") ? m3(e, i) : $.get(i);
      if (typeof a != "function") throw new y(`unknown function pointer with signature ${e}: ${i}`);
      return a;
    }, E2, A2 = (e) => {
      e = z2(e);
      var i = A(e);
      ...
      var r = [], s = {};
      throw i.forEach(a), new E2(`${e}: ` + r.map(A2).join([", "]));
    }, n2 = (e, i) => {
      for (var a = [], r = 0; r < e; r++) a.push(M[i + 4 * r >> 2]);
      return a;
    };
    function g3(e) {
      for (var i = 1; i < e.length; ++i) if (e[i] !== null && e[i].Ja === void 0) return true;
      return false;
    }
    function a2(e, i, a, r, s) {
      var o = i.length;
      if (2 > o) throw new y("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var u = i[1] !== null && a !== null, c = g3(i), f = i[0].name !== "void", m = o - 2, v = Array(m), C = [], b = [];
      return I1(e, function() {
        for (var U = arguments.length, I = new Array(U), j = 0; j < U; j++) I[j] = arguments[j];
        if (b.length = 0, C.length = u ? 2 : 1, C[0] = s, u) {
          var R = i[1].toWireType(b, this);
          C[1] = R;
        }
        for (var P = 0; P < m; ++P) v[P] = i[P + 2].toWireType(b, I[P]), C.push(v[P]);
        if (I = r(...C), c) Y1(b);
        else for (P = u ? 1 : 2; P < i.length; P++) {
          var F = P === 1 ? R : v[P - 2];
          i[P].Ja !== null && i[P].Ja(F);
        }
        return R = f ? i[0].fromWireType(I) : void 0, R;
      });
    }
    var k2 = (e) => {
      e = e.trim();
      let i = e.indexOf("(");
      return i !== -1 ? e.substr(0, i) : e;
    }, r2 = [], t1 = [], s2 = (e) => {
      9 < e && --t1[e + 1] === 0 && (t1[e] = void 0, r2.push(e));
    }, p1 = (e) => {
      ...
      switch (e) {
        ...
        case false:
          return 8;
        default:
          let i = r2.pop() || t1.length;
          return t1[i] = e, t1[i + 1] = 1, i;
      }
    }, D2 = { name: "emscripten::val", fromWireType: (e) => {
      var i = p1(e);
      return s2(e), i;
    }, toWireType: (e, i) => z1(i), Ia: 8, readValueFromPointer: M1, Ja: null }, L3 = (e, i, a) => {
      switch (i) {
        case 1:
          return a ? function(r) {
        ...
        default:
          throw new TypeError(`invalid integer width (${i}): ${e}`);
      }
    }, B1 = (e, i) => {
      var a = h1[e];
      if (a === void 0) throw e = `${i} has unknown type ${A2(e)}`, new y(e);
      return a;
    }, o2 = (e) => {
      if (e === null) return "null";
      var i = typeof e;
      return i === "object" || i === "array" || i === "function" ? e.toString() : "" + e;
    }, y3 = (e, i) => {
      switch (i) {
        case 4:
          return function(a) {
        ...
        default:
          throw new TypeError(`invalid float width (${i}): ${e}`);
      }
    }, w3 = (e, i, a) => {
      switch (i) {
        case 1:
          return a ? (r) => B[r] : (r) => O[r];
        case 2:
          return a ? (r) => n1[r >> 1] : (r) => Z[r >> 1];
        case 4:
          return a ? (r) => w[r >> 2] : (r) => M[r >> 2];
        default:
          throw new TypeError(`invalid integer width (${i}): ${e}`);
      }
    }, C3 = Object.assign({ optional: true }, D2), T2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, M3 = (e, i) => {
      for (var a = e >> 1, r = a + i / 2; !(a >= r) && Z[a]; ) ++a;
      if (a <<= 1, 32 < a - e && T2) return T2.decode(O.subarray(e, a));
      for (a = "", r = 0; !(r >= i / 2); ++r) {
        var s = n1[e + 2 * r >> 1];
        if (s == 0) break;
      ...
      for (var o = 0; o < a; ++o) n1[i >> 1] = e.charCodeAt(o), i += 2;
      return n1[i >> 1] = 0, i - s;
    }, S3 = (e) => 2 * e.length, I3 = (e, i) => {
      for (var a = 0, r = ""; !(a >= i / 4); ) {
        var s = w[e + 4 * a >> 2];
        if (s == 0) break;
      ...
      for (var o = 0; o < e.length; ++o) {
        ...
        if (w[i >> 2] = u, i += 4, i + 4 > a) break;
      }
      return w[i >> 2] = 0, i - s;
    }, O3 = (e) => {
      for (var i = 0, a = 0; a < e.length; ++a) {
        var r = e.charCodeAt(a);
        55296 <= r && 57343 >= r && ++a, i += 4;
      }
      return i;
    }, h2 = 0, F2 = (e, i, a) => {
      var r = [];
      return e = e.toWireType(r, a), r.length && (M[i >> 2] = z1(r)), e;
    }, d2 = [], E3 = (e) => {
      var i = d2.length;
      return d2.push(e), i;
    }, A3 = (e, i) => {
      for (var a = Array(e), r = 0; r < e; ++r) a[r] = B1(M[i + 4 * r >> 2], "parameter " + r);
      return a;
    }, k3 = Reflect.construct, O1 = {}, R2 = (e) => {
      if (!(e instanceof y2 || e == "unwind")) throw e;
    }, W2 = (e) => {
      var i;
      throw f1 = e, X1 || 0 < h2 || ((i = l.onExit) !== null && i !== void 0 && i.call(l, e), _1 = true), new y2(e);
    }, D3 = (e) => {
      if (!_1) try {
        if (e(), !(X1 || 0 < h2)) try {
          f1 = e = f1, W2(e);
      ...
      if (!c2) {
        var e = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: c1 || "./this.program" }, i;
        for (i in l2) l2[i] === void 0 ? delete e[i] : e[i] = l2[i];
        var a = [];
        for (i in e) a.push(`${i}=${e[i]}`);
        c2 = a;
      }
      return c2;
    }, c2, T3 = () => {
    ...
    b1 = l.InternalError = class extends Error {
      constructor(e) {
        super(e), this.name = "InternalError";
      }
    };
    for (var U2 = Array(256), H1 = 0; 256 > H1; ++H1) U2[H1] = String.fromCharCode(H1);
    M2 = U2, y = l.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign($1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof $1 && e instanceof $1)) return false;
      var i = this.Aa.Da.Ba, a = this.Aa.Ca;
      e.Aa = e.Aa;
      var r = e.Aa.Da.Ba;
      for (e = e.Aa.Ca; i.Ga; ) a = i.Qa(a), i = i.Ga;
      for (; r.Ga; ) e = r.Qa(e), r = r.Ga;
      return i === r && a === e;
    }, clone: function() {
      if (this.Aa.Ca || Z1(this), this.Aa.Pa) return this.Aa.count.value += 1, this;
      var e = S1, i = Object, a = i.create, r = Object.getPrototypeOf(this), s = this.Aa;
      return e = e(a.call(i, r, { Aa: { value: { count: s.count, Oa: s.Oa, Pa: s.Pa, Ca: s.Ca, Da: s.Da, Fa: s.Fa, Ha: s.Ha } } })), e.Aa.count.value += 1, e.Aa.Oa = false, e;
    }, delete() {
      if (this.Aa.Ca || Z1(this), this.Aa.Oa && !this.Aa.Pa) throw new y("Object already scheduled for deletion");
      b2(this);
      var e = this.Aa;
    ...
    } }), Object.assign(P1.prototype, { cb(e) {
      return this.Ya && (e = this.Ya(e)), e;
    }, Wa(e) {
      var i;
      (i = this.Ka) === null || i === void 0 || i.call(this, e);
    }, Ia: 8, readValueFromPointer: M1, fromWireType: function(e) {
      function i() {
        return this.Sa ? x1(this.Ba.Ma, { Da: this.ib, Ca: a, Ha: this, Fa: e }) : x1(this.Ba.Ma, { Da: this, Ca: e });
      }
      var a = this.cb(e);
      if (!a) return this.Wa(e), null;
      var r = l3(this.Ba, a);
      if (r !== void 0) return r.Aa.count.value === 0 ? (r.Aa.Ca = a, r.Aa.Fa = e, r.clone()) : (r = r.clone(), this.Wa(e), r);
      if (r = this.Ba.bb(a), r = I2[r], !r) return i.call(this);
      r = this.Ra ? r.Za : r.pointerType;
      var s = S2(a, this.Ba, r.Ba);
      return s === null ? i.call(this) : this.Sa ? x1(r.Ba.Ma, { Da: r, Ca: s, Ha: this, Fa: e }) : x1(r.Ba.Ma, { Da: r, Ca: s });
    } }), E2 = l.UnboundTypeError = ((e, i) => {
      var a = I1(i, function(r) {
        this.name = i, this.message = r, r = Error(r).stack, r !== void 0 && (this.stack = this.toString() + `
` + r.replace(/^Error(:[^\n]*)?\n/, ""));
      });
      return a.prototype = Object.create(e.prototype), a.prototype.constructor = a, a.prototype.toString = function() {
        return this.message === void 0 ? this.name : `${this.name}: ${this.message}`;
      }, a;
    })(Error, "UnboundTypeError"), t1.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), l.count_emval_handles = () => t1.length / 2 - 5 - r2.length;
    var F3 = { c: (e, i, a, r) => D1(`Assertion failed: ${e ? F1(e) : ""}, at: ` + [i ? i ? F1(i) : "" : "unknown filename", a, r ? r ? F1(r) : "" : "unknown function"]), j: (e, i, a) => {
      var r = new o3(e);
      throw M[r.Ca + 16 >> 2] = 0, M[r.Ca + 4 >> 2] = i, M[r.Ca + 8 >> 2] = a, C2 = e, C2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      var i = R1[e];
      delete R1[e];
      var a = i.Ua, r = i.Ka, s = i.Xa, o = s.map((u) => u.gb).concat(s.map((u) => u.mb));
      a1([e], o, (u) => {
        var c = {};
        return s.forEach((f, m) => {
          var v = u[m], C = f.eb, b = f.fb, U = u[m + s.length], I = f.lb, j = f.nb;
          c[f.ab] = { read: (R) => v.fromWireType(C(b, R)), write: (R, P) => {
            var F = [];
            I(j, R, U.toWireType(F, P)), Y1(F);
          } };
        }), [{ name: i.name, fromWireType: (f) => {
          var m = {}, v;
          ...
          var C = a();
          for (v in c) c[v].write(C, m[v]);
          return f !== null && f.push(r, C), C;
        }, Ia: 8, readValueFromPointer: M1, Ja: r }];
      });
    }, F: () => {
    }, _: (e, i, a, r) => {
      i = A(i), H(e, { name: i, fromWireType: function(s) {
        return !!s;
    ...
    }, k: (e, i, a, r, s, o, u, c, f, m, v, C, b) => {
      v = A(v), o = T(s, o), c && (c = T(u, c)), m && (m = T(f, m)), b = T(C, b);
      var U = c3(v);
      e2(U, function() {
        U1(`Cannot construct ${v} due to unbound types`, [r]);
      }), a1([e, i, a], r ? [r] : [], (I) => {
        if (I = I[0], r) var j = I.Ba, R = j.Ma;
        else R = $1.prototype;
        I = I1(v, function() {
          if (Object.getPrototypeOf(this) !== P) throw new y("Use 'new' to construct " + v);
          if (F.La === void 0) throw new y(v + " has no accessible constructor");
          for (var N2 = arguments.length, N1 = new Array(N2), G1 = 0; G1 < N2; G1++) N1[G1] = arguments[G1];
          var G2 = F.La[N1.length];
          if (G2 === void 0) throw new y(`Tried to invoke ctor of ${v} with invalid number of parameters (${N1.length}) - expected (${Object.keys(F.La).toString()}) parameters instead!`);
          return G2.apply(this, N1);
        });
        var P = Object.create(R, { constructor: { value: I } });
        I.prototype = P;
        var F = new u3(v, I, P, b, j, o, c, m);
        if (F.Ga) {
          var j2, E1;
          (j2 = (E1 = F.Ga).Va) !== null && j2 !== void 0 || (E1.Va = []), F.Ga.Va.push(F);
        }
        return j = new P1(v, F, true, false, false), E1 = new P1(v + "*", F, false, false, false), R = new P1(v + " const*", F, false, true, false), I2[e] = { pointerType: E1, Za: R }, O2(U, I), [j, E1, R];
      });
    }, r: (e, i, a, r, s, o) => {
      var u = n2(i, a);
      s = T(r, s), a1([], [e], (c) => {
        ...
        if (c.Ba.La === void 0 && (c.Ba.La = []), c.Ba.La[i - 1] !== void 0) throw new y(`Cannot register multiple constructors with identical number of parameters (${i - 1}) for class '${c.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return c.Ba.La[i - 1] = () => {
          U1(`Cannot construct ${c.name} due to unbound types`, u);
        }, a1([], u, (m) => (m.splice(1, 0, null), c.Ba.La[i - 1] = a2(f, m, null, s, o), [])), [];
      });
    }, d: (e, i, a, r, s, o, u, c) => {
      var f = n2(a, r);
      i = A(i), i = k2(i), o = T(s, o), a1([], [e], (m) => {
        function v() {
          U1(`Cannot call ${C} due to unbound types`, f);
        }
        m = m[0];
        var C = `${m.name}.${i}`;
        i.startsWith("@@") && (i = Symbol[i.substring(2)]), c && m.Ba.jb.push(i);
        var b = m.Ba.Ma, U = b[i];
        return U === void 0 || U.Ea === void 0 && U.className !== m.name && U.Na === a - 2 ? (v.Na = a - 2, v.className = m.name, b[i] = v) : (P2(b, i, C), b[i].Ea[a - 2] = v), a1([], f, (I) => (I = a2(C, I, m, o, u), b[i].Ea === void 0 ? (I.Na = a - 2, b[i] = I) : b[i].Ea[a - 2] = I, [])), [];
      });
    }, Y: (e) => H(e, D2), D: (e, i, a, r) => {
      function s() {
      }
      i = A(i), s.values = {}, H(e, { name: i, constructor: s, fromWireType: function(o) {
        return this.constructor.values[o];
      }, toWireType: (o, u) => u.value, Ia: 8, readValueFromPointer: L3(i, a, r), Ja: null }), e2(i, s);
    }, m: (e, i, a) => {
      var r = B1(e, "enum");
      i = A(i), e = r.constructor, r = Object.create(r.constructor.prototype, { value: { value: a }, constructor: { value: I1(`${r.name}_${i}`, function() {
      }) } }), e.values[a] = r, e[i] = r;
    }, A: (e, i, a) => {
      i = A(i), H(e, { name: i, fromWireType: (r) => r, toWireType: (r, s) => s, Ia: 8, readValueFromPointer: y3(i, a), Ja: null });
    }, u: (e, i, a, r, s, o) => {
      var u = n2(i, a);
      e = A(e), e = k2(e), s = T(r, s), e2(e, function() {
        U1(`Cannot call ${e} due to unbound types`, u);
      }, i - 1), a1([], u, (c) => (O2(e, a2(e, [c[0], null].concat(c.slice(1)), null, s, o), i - 1), []));
    }, n: (e, i, a, r, s) => {
      if (i = A(i), s === -1 && (s = 4294967295), s = (c) => c, r === 0) {
        var o = 32 - 8 * a;
        s = (c) => c << o >>> o;
      }
      var u = i.includes("unsigned") ? function(c, f) {
        return f >>> 0;
      } : function(c, f) {
        return f;
      };
      H(e, { name: i, fromWireType: s, toWireType: u, Ia: 8, readValueFromPointer: w3(i, a, r !== 0), Ja: null });
    }, g: (e, i, a) => {
      function r(o) {
        return new s(B.buffer, M[o + 4 >> 2], M[o >> 2]);
      }
      var s = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][i];
      a = A(a), H(e, { name: a, fromWireType: r, Ia: 8, readValueFromPointer: r }, { hb: true });
    }, o: (e) => {
      H(e, C3);
    }, v: (e, i, a, r, s, o, u, c, f, m, v, C) => {
      a = A(a), o = T(s, o), c = T(u, c), m = T(f, m), C = T(v, C), a1([e], [i], (b) => (b = b[0], [new P1(a, b.Ba, false, false, true, b, r, o, c, m, C)]));
    }, Z: (e, i) => {
      i = A(i), H(e, { name: i, fromWireType: function(a) {
        for (var r = M[a >> 2], s = a + 4, o, u = s, c = 0; c <= r; ++c) {
          var f = s + c;
          (c == r || O[f] == 0) && (u = u ? F1(u, f - u) : "", o === void 0 ? o = u : (o += "\0", o += u), u = f + 1);
        }
        return e1(a), o;
      }, toWireType: function(a, r) {
        r instanceof ArrayBuffer && (r = new Uint8Array(r));
        var s, o = typeof r == "string";
        if (!(o || r instanceof Uint8Array || r instanceof Uint8ClampedArray || r instanceof Int8Array)) throw new y("Cannot pass non-string to std::string");
        if (o) for (var u = s = 0; u < r.length; ++u) {
          var c = r.charCodeAt(u);
          127 >= c ? s++ : 2047 >= c ? s += 2 : 55296 <= c && 57343 >= c ? (s += 4, ++u) : s += 3;
        }
        else s = r.length;
        if (u = u2(4 + s + 1), c = u + 4, M[u >> 2] = s, o) C1(r, c, s + 1);
        else if (o) for (o = 0; o < s; ++o) {
          var f = r.charCodeAt(o);
          if (255 < f) throw e1(c), new y("String has UTF-16 code units that do not fit in 8 bits");
          O[c + o] = f;
        }
        else for (o = 0; o < s; ++o) O[c + o] = r[o];
        return a !== null && a.push(e1, u), u;
      }, Ia: 8, readValueFromPointer: M1, Ja(a) {
        e1(a);
      } });
    }, y: (e, i, a) => {
      if (a = A(a), i === 2) var r = M3, s = b3, o = S3, u = (c) => Z[c >> 1];
      else i === 4 && (r = I3, s = P3, o = O3, u = (c) => M[c >> 2]);
      H(e, { name: a, fromWireType: (c) => {
        for (var f = M[c >> 2], m, v = c + 4, C = 0; C <= f; ++C) {
          var b = c + 4 + C * i;
          (C == f || u(b) == 0) && (v = r(v, b - v), m === void 0 ? m = v : (m += "\0", m += v), v = b + i);
        }
        return e1(c), m;
      }, toWireType: (c, f) => {
        if (typeof f != "string") throw new y(`Cannot pass non-string to C++ string type ${a}`);
        var m = o(f), v = u2(4 + m + i);
        return M[v >> 2] = m / i, s(f, v + 4, m + i), c !== null && c.push(e1, v), v;
      }, Ia: 8, readValueFromPointer: M1, Ja(c) {
        e1(c);
      } });
    }, x: (e, i, a, r, s, o) => {
      R1[e] = { name: A(i), Ua: T(a, r), Ka: T(s, o), Xa: [] };
    }, i: (e, i, a, r, s, o, u, c, f, m) => {
      R1[e].Xa.push({ ab: A(i), gb: a, eb: T(r, s), fb: o, mb: u, lb: T(c, f), nb: m });
    }, $: (e, i) => {
      i = A(i), H(e, { pb: true, name: i, Ia: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, K: () => {
      X1 = false, h2 = 0;
      ...
      throw 1 / 0;
    }, C: (e, i, a) => (e = p1(e), i = B1(i, "emval::as"), F2(i, a, e)), q: (e, i, a, r) => (e = d2[e], i = p1(i), e(null, i, a, r)), W: s2, E: (e, i) => (e = p1(e), i = p1(i), e == i), p: (e, i, a) => {
      var r = A3(e, i), s = r.shift();
      e--;
      var o = Array(e);
      return i = `methodCaller<(${r.map((u) => u.name).join(", ")}) => ${s.name}>`, E3(I1(i, (u, c, f, m) => {
        for (var v = 0, C = 0; C < e; ++C) o[C] = r[C].readValueFromPointer(m + v), v += r[C].Ia;
        return u = a === 1 ? k3(c, o) : c.apply(u, o), F2(s, f, u);
      }));
    }, z: (e) => {
      9 < e && (t1[e + 1] += 1);
    }, ca: (e) => {
      var i = p1(e);
      Y1(i), s2(e);
    }, s: (e, i) => (e = B1(e, "_emval_take_value"), e = e.readValueFromPointer(i), z1(e)), G: (e, i) => {
      if (O1[e] && (clearTimeout(O1[e].id), delete O1[e]), !i) return 0;
      var a = setTimeout(() => {
        delete O1[e], D3(() => B2(e, performance.now()));
      }, i);
      return O1[e] = { id: a, qb: i }, 0;
    }, H: (e, i, a, r) => {
      var s = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(s, 0, 1).getTimezoneOffset();
      s = new Date(s, 6, 1).getTimezoneOffset(), M[e >> 2] = 60 * Math.max(o, s), w[i >> 2] = +(o != s), i = (u) => {
        var c = Math.abs(u);
        return `UTC${0 <= u ? "-" : "+"}${String(Math.floor(c / 60)).padStart(2, "0")}${String(c % 60).padStart(2, "0")}`;
      }, e = i(o), i = i(s), s < o ? (C1(e, a, 17), C1(i, r, 17)) : (C1(e, r, 17), C1(i, a, 17));
      ...
      for (var a = 1; 4 >= a; a *= 2) {
        ...
        t: {
          r = (Math.min(2147483648, 65536 * Math.ceil(Math.max(e, r) / 65536)) - K.buffer.byteLength + 65535) / 65536 | 0;
          try {
            K.grow(r), s1();
            var s = 1;
            break t;
      ...
      return x2().forEach((r, s) => {
        var o = i + a;
        for (s = M[e + 4 * s >> 2] = o, o = 0; o < r.length; ++o) B[s++] = r.charCodeAt(o);
        B[s] = 0, a += r.length + 1;
      }), 0;
    }, X: (e, i) => {
      var a = x2();
      M[e >> 2] = a.length;
      var r = 0;
      return a.forEach((s) => r += s.length + 1), M[i >> 2] = r, 0;
    }, S: () => 52, Q: () => 52, l: R3, f: U3, e: H3, B: W3, aa: B3, a: x3, b: z3, h: $3, t: j3, U: W2, L: (e, i) => ($2(O.subarray(e, e + i)), 0) }, S;
    (async function(e, i) {
      function a(o) {
        var u;
        return S = o.exports, K = S.da, s1(), $ = S.ga, x.unshift(S.ea), o1--, (u = l.monitorRunDependencies) === null || u === void 0 || u.call(l, o1), o1 == 0 && w1 && (o = w1, w1 = null, o()), S;
      }
      o1++, (e = l.monitorRunDependencies) === null || e === void 0 || e.call(l, o1);
      var r = { a: F3 };
      if (l.instantiateWasm) try {
        return l.instantiateWasm(r, a);
      } catch (o) {
        q(`Module.instantiateWasm callback failed with error: ${o}`), V(o);
      }
      (i = T1) !== null && i !== void 0 || (T1 = L2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : l.locateFile ? l.locateFile("DotLottiePlayer.wasm", D) : D + "DotLottiePlayer.wasm");
      try {
        var s = await s3(r);
    ...
    var u2 = (e) => (u2 = S.fa)(e), e1 = (e) => (e1 = S.ha)(e), z2 = (e) => (z2 = S.ia)(e), B2 = (e, i) => (B2 = S.ja)(e, i), Q = (e, i) => (Q = S.ka)(e, i), X = (e) => (X = S.la)(e), Y = () => (Y = S.ma)();
    l.dynCall_jiii = (e, i, a, r) => (l.dynCall_jiii = S.na)(e, i, a, r), l.dynCall_jii = (e, i, a) => (l.dynCall_jii = S.oa)(e, i, a), l.dynCall_vjii = (e, i, a, r, s) => (l.dynCall_vjii = S.pa)(e, i, a, r, s), l.dynCall_vjfii = (e, i, a, r, s, o) => (l.dynCall_vjfii = S.qa)(e, i, a, r, s, o), l.dynCall_vjiii = (e, i, a, r, s, o) => (l.dynCall_vjiii = S.ra)(e, i, a, r, s, o), l.dynCall_vj = (e, i, a) => (l.dynCall_vj = S.sa)(e, i, a), l.dynCall_vjiiiii = (e, i, a, r, s, o, u, c) => (l.dynCall_vjiiiii = S.ta)(e, i, a, r, s, o, u, c), l.dynCall_vjiffii = (e, i, a, r, s, o, u, c) => (l.dynCall_vjiffii = S.ua)(e, i, a, r, s, o, u, c), l.dynCall_vjiiii = (e, i, a, r, s, o, u) => (l.dynCall_vjiiii = S.va)(e, i, a, r, s, o, u), l.dynCall_viijii = (e, i, a, r, s, o, u) => (l.dynCall_viijii = S.wa)(e, i, a, r, s, o, u), l.dynCall_iiiiij = (e, i, a, r, s, o, u) => (l.dynCall_iiiiij = S.xa)(e, i, a, r, s, o, u), l.dynCall_iiiiijj = (e, i, a, r, s, o, u, c, f) => (l.dynCall_iiiiijj = S.ya)(e, i, a, r, s, o, u, c, f), l.dynCall_iiiiiijj = (e, i, a, r, s, o, u, c, f, m) => (l.dynCall_iiiiiijj = S.za)(e, i, a, r, s, o, u, c, f, m);
    function R3(e, i) {
      var a = Y();
      try {
        return $.get(e)(i);
    ...
    function W3(e, i, a, r, s, o) {
      var u = Y();
      try {
        return $.get(e)(i, a, r, s, o);
      } catch (c) {
        if (X(u), c !== c + 0) throw c;
        Q(1, 0);
      }
    }
    function x3(e, i) {
    ...
    function j3(e, i, a, r, s) {
      var o = Y();
      try {
        $.get(e)(i, a, r, s);
      } catch (u) {
        if (X(o), u !== u + 0) throw u;
        Q(1, 0);
      }
    }
    var j1;
    ...
    function H2() {
      function e() {
        if (!j1 && (j1 = true, l.calledRun = true, !_1)) {
          var i;
          if (Q1(x), W(l), (i = l.onRuntimeInitialized) === null || i === void 0 || i.call(l), l.postRun) for (typeof l.postRun == "function" && (l.postRun = [l.postRun]); l.postRun.length; ) {
      ...
      if (!(0 < o1)) {
        if (l.preRun) for (typeof l.preRun == "function" && (l.preRun = [l.preRun]); l.preRun.length; ) n3();
        Q1(k1), 0 < o1 || (l.setStatus ? (l.setStatus("Running..."), setTimeout(() => {
...
var A1 = class {
  ...
  static async _tryLoad(d) {
    return await Z3({ locateFile: () => d });
  }
  static async _loadWithBackup() {
    return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (d) => {
      let t = `https://unpkg.com/${Y2}@${X2}/dist/dotlottie-player.wasm`;
      console.warn(`Primary WASM load failed from ${this._wasmURL}. Error: ${d.message}`), console.warn(`Attempting to load WASM from backup URL: ${t}`);
      try {
        return await this._tryLoad(t);
      } catch (n) {
...
var Z2 = class {
  ...
  addEventListener(d, t) {
    let n = this._eventListeners.get(d);
    n || (n = /* @__PURE__ */ new Set(), this._eventListeners.set(d, n)), n.add(t);
  }
  removeEventListener(d, t) {
    let n = this._eventListeners.get(d);
    n && (t ? (n.delete(t), n.size === 0 && this._eventListeners.delete(d)) : this._eventListeners.delete(d));
  }
  dispatch(d) {
    this._eventListeners.get(d.type)?.forEach((t) => t(d));
  }
...
var N = class {
  ...
  static observe(d, t) {
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, t), this._observer?.observe(d));
  }
  static unobserve(d) {
  ...
  static _initializeObserver() {
    ...
    let d = (t) => {
      t.forEach((n) => {
        ...
        this._observedCanvases.set(n.target, [_, l]);
      });
    };
    this._observer = new ResizeObserver(d);
  }
  static observe(d, t) {
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, [t, 0]), this._observer?.observe(d));
  }
  static unobserve(d) {
    let t = this._observedCanvases.get(d);
    if (t) {
      let n = t[1];
      n && clearTimeout(n);
    }
...
function V2(d) {
  ...
  let t = new Uint8Array(d.slice(0, _2.byteLength));
  for (let n = 0; n < _2.length; n += 1) if (_2[n] !== t[n]) return false;
  return true;
}
function J2(d) {
  return K3.every((t) => Object.prototype.hasOwnProperty.call(d, t));
}
function q2(d) {
...
function l1(d) {
  let t = d.getBoundingClientRect(), n = window.innerHeight || document.documentElement.clientHeight, h = window.innerWidth || document.documentElement.clientWidth;
  return !(t.bottom < 0 || t.top > n || t.right < 0 || t.left > h);
}
function z(d) {
  let t = d.target;
  if (t instanceof HTMLCanvasElement) {
    ...
    let h = t.width / n.width, _ = t.height / n.height, g = (d.clientX - n.left) * h, l = (d.clientY - n.top) * _;
    return !Number.isFinite(g) || !Number.isFinite(l) || Number.isNaN(g) || Number.isNaN(l) ? null : { x: g, y: l };
  }
  return null;
}
function t3(d) {
  let t = d.replace("OpenUrl: ", ""), n = t.indexOf(" | Target: "), h, _;
  n === -1 ? (h = t, _ = "_blank") : (h = t.substring(0, n), _ = t.substring(n + 11)), window.open(h, _);
}
var K2 = (d, t) => {
  let n = new d.VectorChar(), h = new Uint8Array(t);
...
var f2 = (d, t) => d === "reverse" ? t.Mode.Reverse : d === "bounce" ? t.Mode.Bounce : d === "reverse-bounce" ? t.Mode.ReverseBounce : t.Mode.Forward;
var i0 = (d, t) => d === "contain" ? t.Fit.Contain : d === "cover" ? t.Fit.Cover : d === "fill" ? t.Fit.Fill : d === "fit-height" ? t.Fit.FitHeight : d === "fit-width" ? t.Fit.FitWidth : t.Fit.None;
var n0 = (d, t) => {
...
var e3 = class L {
  ...
  async _fetchData(t) {
    let n = await fetch(t);
    if (!n.ok) throw new Error(`Failed to fetch animation data from URL: ${t}. ${n.status}: ${n.statusText}`);
    let h = await n.arrayBuffer();
    return V2(h) ? h : new TextDecoder().decode(h);
  }
  _loadFromData(t) {
    ...
    if (typeof t == "string") {
      ...
      _ = this._dotLottieCore.loadDotLottieData(K2(L._wasmModule, t), n, h);
    } else if (typeof t == "object") {
      if (!q2(t)) {
        this._dispatchError("Invalid Lottie JSON object: The provided object does not conform to the Lottie JSON format.");
        return;
      }
      _ = this._dotLottieCore.loadAnimationData(JSON.stringify(t), n, h);
    } else {
  ...
  _loadFromSrc(t) {
    this._fetchData(t).then((n) => this._loadFromData(n)).catch((n) => this._dispatchError(`Failed to load animation data from URL: ${t}. ${n}`));
  }
  get buffer() {
  ...
  get mode() {
    ...
    return t === L._wasmModule?.Mode.Reverse ? "reverse" : t === L._wasmModule?.Mode.Bounce ? "bounce" : t === L._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(t) {
    this._dotLottieCore === null || L._wasmModule === null || (this._stopAnimationLoop(), this._cleanupCanvas(), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: t.animationId ?? "", themeId: t.themeId ?? "", stateMachineId: "", autoplay: t.autoplay ?? false, backgroundColor: 0, loopAnimation: t.loop ?? false, loopCount: t.loopCount ?? 0, mode: f2(t.mode ?? "forward", L._wasmModule), segment: v2(t.segment ?? [], L._wasmModule), speed: t.speed ?? 1, useFrameInterpolation: t.useFrameInterpolation ?? true, marker: t.marker ?? "", layout: p2(t.layout, L._wasmModule) }), t.data ? this._canvas ? this._loadFromData(t.data) : this._pendingLoad = { data: t.data } : t.src && (this._canvas ? this._loadFromSrc(t.src) : this._pendingLoad = { src: t.src }), this.setBackgroundColor(t.backgroundColor ?? ""));
  }
  _draw() {
    if (!(this._dotLottieCore === null || this._canvas === null) && (!this._context && "getContext" in this._canvas && typeof this._canvas.getContext == "function" && (typeof HTMLCanvasElement < "u" && this._canvas instanceof HTMLCanvasElement || typeof OffscreenCanvas < "u" && this._canvas instanceof OffscreenCanvas) && (this._context = this._canvas.getContext("2d")), this._context)) {
      let t = this._dotLottieCore.buffer(), n = this._canvas.width * this._canvas.height * X3;
      if (t.byteLength !== n) {
      ...
      let h = null, _ = new Uint8ClampedArray(t, 0, t.byteLength);
      typeof ImageData > "u" ? (h = this._context.createImageData(this._canvas.width, this._canvas.height), h.data.set(_)) : h = new ImageData(_, this._canvas.width, this._canvas.height), this._context.putImageData(h, 0, 0);
    }
  }
  _cleanupCanvas() {
    this._canvas && E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas), this._cleanupStateMachineListeners());
  }
  _initializeCanvas() {
    this._context = null, this._canvas && E && this._canvas instanceof HTMLCanvasElement && this.isLoaded && (this._renderConfig.freezeOnOffscreen && (N.observe(this._canvas, this), l1(this._canvas) || this.freeze()), this._renderConfig.autoResize && G.observe(this._canvas, this), this._isStateMachineRunning && this._setupStateMachineListeners()), this._canvas && this._dotLottieCore && this.isLoaded && this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
  }
  _stopAnimationLoop() {
  ...
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), this._canvas && E && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !l1(this._canvas) && this.freeze());
  }
  pause() {
  ...
  setFrame(t) {
    this._dotLottieCore !== null && this._dotLottieCore.seek(t) && this._dotLottieCore.render() && this._draw();
  }
  setSpeed(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), speed: t });
  }
  setBackgroundColor(t) {
    this._dotLottieCore !== null && (E && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = t : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: e0(t) }), this._backgroundColor = t);
  }
  setLoop(t) {
  ...
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded || !this._canvas)) {
      if (E && this._canvas instanceof HTMLCanvasElement) {
        let t = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: n, width: h } = this._canvas.getBoundingClientRect();
        n !== 0 && h !== 0 && (this._canvas.width = h * t, this._canvas.height = n * t);
      }
  ...
  setTransform(t) {
    ...
    for (let _ of t) n.push_back(_);
    let h = this._dotLottieCore.setTransform(n);
    return h && this._dotLottieCore.render() && this._draw(), h;
  }
  getTransform() {
    if (!this._dotLottieCore) return;
    let t = [0, 0, 0, 0, 0, 0, 0, 0, 0], n = this._dotLottieCore.getTransform();
    for (let h = 0; h < n.size(); h += 1) t[h] = n.get(h);
    return t;
  }
  setSegment(t, n) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: v2([t, n], L._wasmModule) });
  }
  setMode(t) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: f2(t, L._wasmModule) });
  }
  setRenderConfig(t) {
    let { devicePixelRatio: n, freezeOnOffscreen: h, quality: _, ...g } = t;
    this._renderConfig = { ...this._renderConfig, ...g, devicePixelRatio: n || d1(), freezeOnOffscreen: h ?? true, ..._ !== void 0 && { quality: _ } }, _ !== void 0 && this._dotLottieCore && this._dotLottieCore.setQuality(_), E && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), l1(this._canvas) || this.freeze()) : (N.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(t) {
    this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === t || !this._canvas || this._dotLottieCore.loadAnimation(t, this._canvas.width, this._canvas.height) && (this._renderConfig.quality !== void 0 && this._dotLottieCore.setQuality(this._renderConfig.quality), this.resize());
  }
  setMarker(t) {
  ...
  setSlots(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setSlots(JSON.stringify(t)) && (this._dotLottieCore.render(), this._draw());
  }
  _isKeyframeArray(t) {
    return Array.isArray(t) && t.length > 0 && typeof t[0] == "object" && t[0] !== null && "t" in t[0] && "s" in t[0];
  }
  _getSlotValue(t) {
    let n = this.getSlot(t);
    if (n && typeof n == "object" && "p" in n) {
      let h = n.p;
  ...
  getSlotIds() {
    if (!this._dotLottieCore) return [];
    let t = this._dotLottieCore.getSlotIds(), n = [];
    for (let h = 0; h < t.size(); h += 1) n.push(t.get(h));
    return n;
  }
  getSlotType(t) {
    if (!this._dotLottieCore) return;
    let n = this._dotLottieCore.getSlotType(t);
    if (n) return n;
  }
  getSlot(t) {
    if (!this._dotLottieCore) return;
    let n = this._dotLottieCore.getSlotStr(t);
    if (n) try {
      return JSON.parse(n);
    } catch {
      return;
  ...
  setColorSlot(t, n) {
    if (this._dotLottieCore === null) return false;
    let h = this._isKeyframeArray(n), _ = JSON.stringify({ a: h ? 1 : 0, k: n });
    return this._dotLottieCore.setSlotStr(t, _) ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  setScalarSlot(t, n) {
    if (this._dotLottieCore === null) return false;
    let h = JSON.stringify({ a: typeof n != "number" ? 1 : 0, k: n });
    return this._dotLottieCore.setSlotStr(t, h) ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  setVectorSlot(t, n) {
    if (this._dotLottieCore === null) return false;
    let h = this._isKeyframeArray(n), _ = JSON.stringify({ a: h ? 1 : 0, k: n });
  ...
  setTextSlot(t, n) {
    if (this._dotLottieCore === null) return false;
    let h = this._getSlotValue(t), _ = n;
    h && typeof h == "object" && !Array.isArray(h) && (_ = { ...h, ...n });
    let g = JSON.stringify({ a: 0, k: _ });
    return this._dotLottieCore.setSlotStr(t, g) ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  resetSlot(t) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.resetSlot(t) ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  clearSlot(t) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.clearSlot(t) ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  resetSlots() {
    return this._dotLottieCore === null ? false : this._dotLottieCore.resetSlots() ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  clearSlots() {
    return this._dotLottieCore === null ? false : this._dotLottieCore.clearSlots() ? (this._dotLottieCore.render(), this._draw(), true) : false;
  }
  setLayout(t) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: p2(t, L._wasmModule) });
  }
  setViewport(t, n, h, _) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(t, n, h, _);
  }
  static setWasmUrl(t) {
    A1.setWasmUrl(t);
  }
  static async registerFont(t, n) {
    try {
      let h = await A1.load(), _;
      if (typeof n == "string") {
        let l = await fetch(n);
        if (!l.ok) return console.error(`Failed to fetch font from URL: ${n}. Status: ${l.status}`), false;
        _ = await l.arrayBuffer();
      } else if (n instanceof Uint8Array) {
        let l = n.buffer.slice(n.byteOffset, n.byteOffset + n.byteLength);
        l instanceof ArrayBuffer ? _ = l : (_ = new ArrayBuffer(n.byteLength), new Uint8Array(_).set(n));
      } else _ = n;
      let g = h.registerFont(t, K2(h, _));
      return g || console.error(`Failed to register font "${t}". Font data may be invalid.`), g;
    } catch (h) {
      return console.error(`Error registering font "${t}":`, h), false;
    }
  }
  tween(t, n) {
    if (!L._wasmModule) return false;
    let h = [0, 0, 1, 1], _ = new L._wasmModule.VectorFloat();
    for (let g of h) _.push_back(g);
    return this._dotLottieCore?.tween(t, n, _) ?? false;
  }
  tweenToMarker(t, n) {
    if (!L._wasmModule) return false;
    let h = [0, 0, 1, 1], _ = new L._wasmModule.VectorFloat();
    for (let g of h) _.push_back(g);
    return this._dotLottieCore?.tweenToMarker(t, n, _) ?? false;
  }
  animationSize() {
    let t = this._dotLottieCore?.animationSize().get(0) ?? 0, n = this._dotLottieCore?.animationSize().get(1) ?? 0;
    return { width: t, height: n };
  }
  getLayerBoundingBox(t) {
    let n = this._dotLottieCore?.getLayerBounds(t);
    if (!n || n.size() !== 8) return;
    let h = [];
    for (let _ = 0; _ < 8; _ += 1) h.push(n.get(_));
    return h;
  }
  static transformThemeToLottieSlots(t, n) {
    return L._wasmModule?.transformThemeToLottieSlots(t, n) ?? "";
  }
  _setupStateMachineObservers() {
    if (!this._dotLottieCore || !L._wasmModule) return;
    let t = new L._wasmModule.CallbackStateMachineObserver();
    t.setOnStart(() => {
      setTimeout(() => {
    ...
    }), t.setOnCustomEvent((h) => {
      this._eventManager.dispatch({ type: "stateMachineCustomEvent", eventName: h });
    }), t.setOnBooleanInputValueChange((h, _, g) => {
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: h, newValue: g, oldValue: _ });
    }), t.setOnNumericInputValueChange((h, _, g) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: h, newValue: g, oldValue: _ });
    }), t.setOnStringInputValueChange((h, _, g) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: h, newValue: g, oldValue: _ });
    }), t.setOnInputFired((h) => {
      this._eventManager.dispatch({ type: "stateMachineInputFired", inputName: h });
    }), t.setOnTransition((h, _) => {
      this._eventManager.dispatch({ type: "stateMachineTransition", fromState: h, toState: _ });
    }), t.setOnStateEntered((h) => {
      this._eventManager.dispatch({ type: "stateMachineStateEntered", state: h });
    }), t.setOnStateExit((h) => {
      this._eventManager.dispatch({ type: "stateMachineStateExit", state: h });
    }), t.setOnError((h) => {
      this._eventManager.dispatch({ type: "stateMachineError", error: h });
    });
    let n = new L._wasmModule.CallbackStateMachineInternalObserver();
    n.setOnMessage((h) => {
      E ? h.startsWith("OpenUrl: ") && t3(h) : this._eventManager.dispatch({ type: "stateMachineInternalMessage", message: h });
    }), this._stateMachineObserverHandle = this._dotLottieCore.stateMachineSubscribe(t), this._stateMachineInternalMessageObserver = this._dotLottieCore.stateMachineInternalSubscribe(n);
  }
  ...
  stateMachineLoad(t) {
    ...
    let n = this._dotLottieCore.stateMachineLoad(t);
    return n && this._setupStateMachineObservers(), n;
  }
  stateMachineLoadData(t) {
    if (!this._dotLottieCore || !L._wasmModule) return false;
    this._cleanupStateMachineObservers();
    let n = this._dotLottieCore.stateMachineLoadData(t);
    return n && this._setupStateMachineObservers(), n;
  }
  ...
  stateMachineStart() {
    ...
    let t = L._wasmModule.createDefaultOpenUrlPolicy();
    if (this._stateMachineConfig) {
      let h = this._stateMachineConfig.openUrlPolicy;
      if (h && typeof h.requireUserInteraction == "boolean" && (t.requireUserInteraction = h.requireUserInteraction), h?.whitelist) {
        t.whitelist = new L._wasmModule.VectorString();
        for (let _ of h.whitelist) t.whitelist.push_back(_);
      }
    }
    let n = this._dotLottieCore.stateMachineStart(t);
  ...
  stateMachineOverrideState(t, n = false) {
    return this._dotLottieCore?.stateMachineOverrideCurrentState(t, n) ?? false;
  }
  stateMachineGet(t) {
  ...
  stateMachineGetListeners() {
    if (!this._dotLottieCore) return [];
    let t = this._dotLottieCore.stateMachineFrameworkSetup(), n = [];
    for (let h = 0; h < t.size(); h += 1) n.push(t.get(h));
    return n;
  }
  stateMachineSetBooleanInput(t, n) {
    return this._dotLottieCore?.stateMachineSetBooleanInput(t, n) ?? false;
  }
  stateMachineSetNumericInput(t, n) {
    return this._dotLottieCore?.stateMachineSetNumericInput(t, n) ?? false;
  }
  stateMachineSetStringInput(t, n) {
    return this._dotLottieCore?.stateMachineSetStringInput(t, n) ?? false;
  }
  ...
  stateMachineGetInputs() {
    if (!this._dotLottieCore) return [];
    let t = this._dotLottieCore.stateMachineGetInputs(), n = [];
    for (let h = 0; h < t.size(); h += 1) n.push(t.get(h));
    return n;
  }
  ...
  stateMachinePostClickEvent(t, n) {
    this._dotLottieCore?.stateMachinePostClickEvent(t, n);
  }
  stateMachinePostPointerUpEvent(t, n) {
    this._dotLottieCore?.stateMachinePostPointerUpEvent(t, n);
  }
  stateMachinePostPointerDownEvent(t, n) {
    this._dotLottieCore?.stateMachinePostPointerDownEvent(t, n);
  }
  stateMachinePostPointerMoveEvent(t, n) {
    this._dotLottieCore?.stateMachinePostPointerMoveEvent(t, n);
  }
  stateMachinePostPointerEnterEvent(t, n) {
    this._dotLottieCore?.stateMachinePostPointerEnterEvent(t, n);
  }
  stateMachinePostPointerExitEvent(t, n) {
...
var s0 = class {
  ...
  getWorker(d) {
    return this._workers.has(d) || this._workers.set(d, new r0()), this._workers.get(d);
  }
  assignAnimationToWorker(d, t) {
    this._animationWorkerMap.set(d, t);
  }
  unassignAnimationFromWorker(d) {
    this._animationWorkerMap.delete(d);
  }
  sendMessage(d, t, n) {
    this.getWorker(d).postMessage(t, n || []);
  }
  broadcastMessage(d, t) {
    this._workers.forEach((n) => {
      n.postMessage(d, t || []);
    });
  }
  terminateWorker(d) {
    let t = this._workers.get(d);
    t && (t.terminate(), this._workers.delete(d));
  }
};
function Q2(d, t) {
  if (typeof HTMLCanvasElement < "u" && d instanceof HTMLCanvasElement) {
    let { height: n, width: h } = d.getBoundingClientRect();
    if (n !== 0 && h !== 0) return { width: h * t, height: n * t };
  }
...
var g2 = class r1 {
  ...
  async _handleWorkerEvent(t) {
    ...
    if (!n.id && (n.method === "onLoad" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event), E && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && (N.observe(this._canvas, this), l1(this._canvas) || await this.freeze()), this._dotLottieInstanceState.renderConfig.autoResize && G.observe(this._canvas, this))), n.method === "onComplete" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onDestroy" && n.result.instanceId === this._id && this._eventManager.dispatch(n.result.event), n.method === "onUnfreeze" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._dotLottieInstanceState.isFrozen = false, this._eventManager.dispatch(n.result.event)), n.method === "onFrame" && n.result.instanceId === this._id && (this._dotLottieInstanceState.currentFrame = n.result.event.currentFrame, this._eventManager.dispatch(n.result.event)), n.method === "onRender" && n.result.instanceId === this._id && this._eventManager.dispatch(n.result.event), n.method === "onFreeze" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onPause" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onPlay" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStop" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onLoadError" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onRenderError" && n.result.instanceId === this._id && this._eventManager.dispatch(n.result.event), n.method === "onReady" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onLoop" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineStart" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._setupStateMachineListeners(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineStop" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._cleanupStateMachineListeners(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineTransition" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineStateEntered" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineStateExit" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineCustomEvent" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineError" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineBooleanInputValueChange" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineNumericInputValueChange" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineStringInputValueChange" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineInputFired" && n.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStateMachineInternalMessage" && n.result.instanceId === this._id)) {
      ...
      let h = n.result.event;
      h.message.startsWith("OpenUrl: ") && t3(h.message);
    }
  }
  async _create(t) {
    ...
    let { instanceId: h } = await this._sendMessage("create", { instanceId: this._id, config: { ...t, canvas: n }, ...Q2(this._canvas, t.renderConfig?.devicePixelRatio || d1()) }, [n]);
  ...
  async setCanvas(t) {
    let n = typeof HTMLCanvasElement < "u" && t instanceof HTMLCanvasElement, h = typeof OffscreenCanvas < "u" && t instanceof OffscreenCanvas;
    if (!n && !h) throw new Error("Worker-based DotLottie requires HTMLCanvasElement or OffscreenCanvas");
    if (this._canvas !== t) {
      ...
      this._canvas = t, !this._created && this._pendingConfig && (await this._create(this._pendingConfig), this._pendingConfig = null);
    }
  }
  get autoplay() {
  ...
  async setSegment(t, n) {
    this._created && (await this._sendMessage("setSegment", { instanceId: this._id, segment: [t, n] }), await this._updateDotLottieInstanceState());
  }
  ...
  async load(t) {
    if (!this._created) {
      this._pendingConfig && (this._pendingConfig = { ...this._pendingConfig, ...t });
      return;
    }
    await this._sendMessage("load", { config: t, instanceId: this._id }), await this._updateDotLottieInstanceState();
  }
  async setLoop(t) {
  ...
  async resize() {
    ...
    let { height: t, width: n } = Q2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || d1());
    await this._sendMessage("resize", { height: t, instanceId: this._id, width: n }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
  ...
  async setThemeData(t) {
    if (!this._created) return false;
    let n = await this._sendMessage("setThemeData", { instanceId: this._id, themeData: t });
    return await this._updateDotLottieInstanceState(), n;
  }
  async setViewport(t, n, h, _) {
    return this._created ? this._sendMessage("setViewport", { x: t, y: n, width: h, height: _, instanceId: this._id }) : false;
  }
  async animationSize() {
    return this._created ? this._sendMessage("animationSize", { instanceId: this._id }) : { height: 0, width: 0 };
  }
  async tween(t, n) {
    return this._created ? this._sendMessage("tween", { instanceId: this._id, frame: t, duration: n }) : false;
  }
  async tweenToMarker(t, n) {
    return this._created ? this._sendMessage("tweenToMarker", { instanceId: this._id, marker: t, duration: n }) : false;
  }
  ...
  async _sendMessage(t, n, h) {
    let _ = { id: `dotlottie-request-${m2()}`, method: t, params: n };
    return this._worker.postMessage(_, h || []), new Promise((g, l) => {
      let W = (V) => {
        let J = V.data;
        J.id === _.id && (this._worker.removeEventListener("message", W), J.error ? l(new Error(`Failed to execute method ${t}: ${J.error}`)) : g(J.result));
      };
  ...
  static async registerFont(t, n) {
    try {
      let h = m2();
      return r1._workerManager.broadcastMessage({ id: h, method: "registerFont", params: { fontName: t, fontSource: n } }), true;
    } catch (h) {
      return console.error(`Error broadcasting registerFont for "${t}":`, h), false;
    }
  }
  async stateMachineLoad(t) {
    if (!this._created) return false;
    let n = await this._sendMessage("stateMachineLoad", { instanceId: this._id, stateMachineId: t });
    return await this._updateDotLottieInstanceState(), n;
  }
  async stateMachineLoadData(t) {
    if (!this._created) return false;
    let n = await this._sendMessage("stateMachineLoadData", { instanceId: this._id, stateMachineData: t });
    return await this._updateDotLottieInstanceState(), n;
  }
  ...
  async stateMachineSetNumericInput(t, n) {
    return this._created ? this._sendMessage("stateMachineSetNumericInput", { instanceId: this._id, name: t, value: n }) : false;
  }
  async stateMachineSetBooleanInput(t, n) {
    return this._created ? this._sendMessage("stateMachineSetBooleanInput", { instanceId: this._id, name: t, value: n }) : false;
  }
  ...
  async stateMachineSetStringInput(t, n) {
    return this._created ? this._sendMessage("stateMachineSetStringInput", { instanceId: this._id, name: t, value: n }) : false;
  }
  ...
  async stateMachineOverrideState(t, n = false) {
    return this._created ? this._sendMessage("stateMachineOverrideState", { instanceId: this._id, state: t, immediate: n }) : false;
  }
  ...
  async stateMachinePostClickEvent(t, n) {
    if (this._created) return this._sendMessage("stateMachinePostClickEvent", { instanceId: this._id, x: t, y: n });
  }
  async stateMachinePostPointerUpEvent(t, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerUpEvent", { instanceId: this._id, x: t, y: n });
  }
  async stateMachinePostPointerDownEvent(t, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerDownEvent", { instanceId: this._id, x: t, y: n });
  }
  async stateMachinePostPointerMoveEvent(t, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerMoveEvent", { instanceId: this._id, x: t, y: n });
  }
  async stateMachinePostPointerEnterEvent(t, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerEnterEvent", { instanceId: this._id, x: t, y: n });
  }
...
var J1 = g2;
var K1 = ({ animationId: d, autoplay: t, backgroundColor: n, className: h, createDotLottie: _, data: g, dotLottieRefCallback: l, layout: W, loop: V, mode: J, playOnHover: m1, renderConfig: c1, segment: D, speed: u1, src: q, stateMachineConfig: i1, stateMachineId: K, style: _1, themeData: f1, themeId: B, useFrameInterpolation: O, workerId: n1, ...Z }) => {
  let w = (0, import_react.useRef)(null), M = (0, import_react.useRef)(null), g1 = (0, import_react.useRef)(l), L1 = { speed: u1, mode: J, loop: V, useFrameInterpolation: O, segment: D, backgroundColor: n, autoplay: t, themeId: B, workerId: n1, src: q, data: g, layout: W, renderConfig: c1, animationId: d, stateMachineConfig: i1, stateMachineId: K }, s1 = (0, import_react.useRef)(L1);
  g1.current = l, s1.current = L1;
  let k1 = (0, import_react.useCallback)((x) => {
    M.current = x, x ? w.current = _({ ...s1.current, canvas: x }) : (w.current?.destroy(), w.current = null), g1.current?.(w.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    let x = (y1) => {
      m1 && (y1.type === "mouseenter" && w.current?.play(), y1.type === "mouseleave" && w.current?.pause());
    };
    return M.current?.addEventListener("mouseenter", x), M.current?.addEventListener("mouseleave", x), () => {
      M.current?.removeEventListener("mouseenter", x), M.current?.removeEventListener("mouseleave", x);
    };
  }, [m1]), (0, import_react.useEffect)(() => {
    w.current?.setSpeed(u1 ?? 1);
  }, [u1]), (0, import_react.useEffect)(() => {
    ...
    w.current?.setRenderConfig(c1 ?? {});
  }, [JSON.stringify(c1)]), (0, import_react.useEffect)(() => {
    typeof g != "string" && typeof g != "object" || w.current?.load({ data: g, ...s1.current });
  }, [g]), (0, import_react.useEffect)(() => {
    typeof q == "string" && w.current?.load({ src: q, ...s1.current });
  }, [q]), (0, import_react.useEffect)(() => {
    w.current?.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    w.current?.loadAnimation(d ?? "");
  }, [d]), (0, import_react.useEffect)(() => {
    typeof B == "string" && w.current?.setTheme(B);
  }, [B]), (0, import_react.useEffect)(() => {
    w.current?.setThemeData(f1 ?? "");
  ...
  }, [i1]), (0, import_jsx_runtime.jsx)("div", { className: h, ...!h && { style: { width: "100%", height: "100%", lineHeight: 0, ..._1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: k1, style: { width: "100%", height: "100%" }, ...Z }) });
};
var h0 = (d) => new V1(d);
var E0 = (d) => (0, import_jsx_runtime.jsx)(K1, { ...d, createDotLottie: h0 });
var l0 = (d) => new J1(d);
var F0 = (d) => (0, import_jsx_runtime.jsx)(K1, { ...d, createDotLottie: l0 });
var $0 = (d) => {
  J1.setWasmUrl(d), V1.setWasmUrl(d);
};
export {
